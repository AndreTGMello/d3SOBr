...
var sparqlReceitaTreemapzoom = prefix + " \
  ...
  d3sparql.query(endpoint, sparqlReceitaTreemapzoom, storeReceitaTreemapzoomData);
  setTimeout(main({title: "Receitas "+params[1]}, {key: "Total", values: treemapzoomReceitaData});, 2000)
...
//  });
  ...
  function main(o, data) {
    ...
    var svg = d3.select("#treemapzoomReceita").append("svg")
    ...
    if (opts.title) {
      $("#treemapzoomReceita").prepend("<p class='title'>" + opts.title + "</p>");
    }
...
//      main({title: "Gastos Publicos"}, {key: "Despesas", values: treemapzoomReceitaData});
//    }, 2000);
