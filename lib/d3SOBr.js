...
d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderTabelaCategoriaEconomicaDaReceita);
  d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderPizzaCategoriaEconomicaDaReceita);
...
d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderTabelaOrigem);
  d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderPizzaOrigem);
...
d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderTabelaEspecie);
  d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderPizzaEspecie);
...
d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderTabelaRubrica);
  d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderPizzaRubrica);
...
d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderTabelaAlinea);
...
d3sparql.query(endpoint, sparqlTabelaElementoDeDespesa, renderTabelaSubalinea);
