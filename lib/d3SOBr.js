...
} //http://stackoverflow.com/questions/1309483/redirect-user-to-current-page-with-some-querystring-using-javascript
...
d3sparql.query(endpoint, sparqlTabelaCategoriaEconomicaDaDespesa, renderPizzaGND)
...
d3sparql.query(endpoint, sparqlTabelaCategoriaEconomicaDaDespesa, renderPizzaModalidadeAplicacao)
...
d3sparql.query(endpoint, sparqlTabelaCategoriaEconomicaDaDespesa, renderPizzaElementoDeDespesa)
...
function renderPizzaCategoriaEconomicaDaDespesa(json) {
      var config = {
        "label": "?CategoriaEconomicaDaDespesa",
        "size": "?total",
